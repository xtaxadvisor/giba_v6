...
import EventModal from '../../modals/EventModal'; // Adjusted path to match the correct location
import { EventDetails } from '../..//modals/EventDetails'; // Adjusted path to match the correct location
  ...
  return (
    <div className="space-y-6">
      ...
      <EventModal
        ...
        setSelectedEvent={setSelectedEvent} // Pass setter function to the modal
        setIsEventModalOpen={setIsEventModalOpen} // Pass setter function to the modal
      />
      {/* Event Details Modal */} 
      {/* Adjusted path to match the correct location */}
      {/* This modal should be a separate component */}
      {/* You can use a library like react-modal or similar to create a modal */}
      {/* Example: */}
