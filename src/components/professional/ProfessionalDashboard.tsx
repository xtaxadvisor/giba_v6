...
function ProfessionalDashboard() {
  return (
    <>
      <Helmet>
        <title>Professional Dashboard | ProTaxAdvisors</title>
        <meta name="description" content="View client stats, deadlines, recent activities and upcoming appointments tailored for professionals." />
      </Helmet>
